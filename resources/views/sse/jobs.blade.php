      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class=" ro-box box box-primary" style=" margin-top: 10px;">
            <div class="box-body">
              <form method="POST" action="{{url('/sse/addServiceLoad')}}">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <!-- Modal -->
            <a href="{{url('/sse/addJob')}}" class="btn btn-success floatright">Add Job</a>
          </div><!-- /.box-header -->
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('/sse/editJob/')}}/{{$value->id}}"><i class="fa fa-edit" style="font-size: 20px;"></i></a>
                        <a href="{{ url('/sse/statusJob/delete/')}}/{{$value->id}}" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash" style="color: #d73925; font-size: 20px;"></i></a>
                      </td>
                      ...
                      <!-- <td>@if($value->foc == 1){{'FOC'}}@endif</td> -->
                      <td>
...
<form id="deleteForm" action="{{url('/sse/deleteJobs')}}" method="GET">
