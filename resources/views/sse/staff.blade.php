                ...
                <?php if(count($result)>=1){
                  ...
                  foreach($result as $value) { 
                    ...
                    <tr>
                      <td>
                        {{-- @if($value->status == "0")
                        <a href="{{ url('/sse/editStaffMember/')}}/{{$value->user_id}}" class="btn btn-info" disabled>Edit</a>
                        <a href="{{url('sse/statusStaff/activate')}}/{{$value->user_id}}" class="btn btn-success" onclick="return confirm('Are you sure want to Activate?')">Activate</a>
                        <a href="{{ url('/sse/editEmpHierarchy/')}}/{{$value->user_id}}" class="btn btn-success" disabled>Attendace Shift</a>
                        @else
                        <a href="{{ url('/sse/editStaffMember/')}}/{{$value->user_id}}" class="btn btn-info">Edit</a>
                        <a href="{{url('sse/statusStaff/deactivate')}}/{{$value->user_id}}" class="btn btn-danger" onclick="return confirm('Are you sure want to Deactivate?')">Deactivate</a>
                        <a href="{{ url('/sse/editEmpHierarchy/')}}/{{$value->user_id}}" class="btn btn-success">Attendace Shift</a>
                        @endif --}}
                        @if(!empty($value->dealer_id))
                        <a href="{{ url('/sse/editEmpHierarchy/')}}/{{$value->user_id}}"><i class="fa fa-calendar" style="font-size: 25px; color: #0099CC" title="Attendance Shifting"></i></a>
                        @else
                        <a><i class="fa fa-calendar" style="font-size: 25px; opacity: 0.3; color: #0099cc;"></i></a>
                        @endif
                        {{-- <a href="{{ url('/sse/statusStaff/activate/')}}/{{$value->user_id}}" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger">Delete</a> --}}
                      ...
                      {{-- <td><a href="{{ url('/sse/viewServices/')}}/{{$value->user_id}}" class="btn btn-info">Services</a></td> --}}
