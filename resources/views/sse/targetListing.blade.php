...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('/sse/targets')}}"><i class="fa fa-dashboard"></i> Targets</a></li>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <input type="text" id="month" name="month" placeholder="Select Month" value="{{old('month')}}" class="datePicker form-control" autocomplete="off" readonly/>
                      </div>
                    </div>
                    <!-- <div class="col-md-3">
            ...
            <!-- <a href="{{url('/asm/addTarget')}}" class="btn btn-success floatright">Add Target</a> -->
          </div><!-- /.box-header -->
              ...
              <tbody>
                ...
                ?>
                      ...
                      <tr id="defaultData">
                        ...
                        <!-- <td> -->
                          {{-- <a href="{{ url('/sse/editTempTarget')}}/{{$dealer_id}}/{{$template_id}}/{{$value->id}}" class="btn btn-success">Edit</a> --}}
                        {{-- <a href="{{ url('/sse/statusTarget/delete')}}/{{$value->id}}" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger">Delete</a> --}}
                        <!-- </td> -->
                      </tr>
...
//             html += '<td>'+(i+1)+'</td><td>'+data[i].treatment_id+'</td><td>'+data[i].target_num+'</td><td>'+data[i].customer_price+'</td><td>'+data[i].total_target+'</td><td><a href="{{url('sse/editTempTarget')}}/'+dealer_id+'/'+template_id+'" class="btn btn-md btn-success add" id="add'+data[i].id+'"><b>Edit</b></a></td>';
//           }
