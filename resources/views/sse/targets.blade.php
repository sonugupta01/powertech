            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  {{-- <a href="{{url('/sse/addTarget')}}" class="btn btn-success floatright">Add Target</a> --}}
                </div><!-- /.box-header -->
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>{{$value->month}}</td>
                            <td>
                              <a href="{{ url('/sse/targetListing')}}/{{$value->dealer_id}}/{{$value->template_id}}/{{$value->id}}" class="btn btn-success"><span class="glyphicon glyphicon-chevron-right"></span></a>
