            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  @endif
                  <form role="form" id="Treatmentform" method="POST" action="{{url('/admin/updateImage')}}" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        <img src="{{asset('/images')}}/{{$result->path}}" width="200" height="100">
                      </div>
                      <!-- /.box-body -->
