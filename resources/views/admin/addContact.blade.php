            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  @endif
                  <form role="form" id="Staffform" method="POST" action="{{url('/admin/insertContact')}}" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                          ...
                          <input type="text" class="form-control required" value="{{ old('mobile') }}" id="mobile" name="mobile" placeholder="Enter mobile no." maxlength="10" OnKeypress="return isNumber(event)">
