      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Duplicate of <b>{{get_template_name($temp_id)}}</b> Template</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            ...
            @endif
            <form role="form" id="duplicateTemplateForm" method="POST" action="{{url('/admin/insertDuplicateTemplate')}}">
                ...
                <div class="box-body">
                  <div class="form-group{{ $errors->has('temp_name') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control required" value="{{ old('temp_name', $templateData->temp_name) }}" id="temp_name" name="temp_name" placeholder="Enter Template Name">
                  ...
                  <div class="form-group{{ $errors->has('temp_description') ? ' has-error' : '' }}">
                    ...
                    <textarea type="text" name="temp_description" class="form-control required" id="temp_description" placeholder="Enter Template Description">{{ old('temp_description',$templateData->temp_description) }}</textarea>
