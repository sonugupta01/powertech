            ...
            <form action="" class="" method="GET" id="filterForm"> 
              <div class="row">
                <div class="col-xs-12 col-md-offset-2 col-md-8">
                  ...
                  <div class="form-group report-field col-md-6 col-sm-6 col-xs-12">
                    <label>Dealer</label>
                    <select class="form-control" id="dealer_id" name="dealer_id" onchange="this.form.submit()">
                  ...
                  <div class="form-group report-field col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select class="form-control" id="treatment_type" name="treatment_type" onchange="this.form.submit()">
                      <option value="">Select Treatment Type</option>
                      <option {{(@request()->treatment_type=="0")?'selected':''}} value="0">Normal</option>
                      <option {{(@request()->treatment_type=="1")?'selected':''}} value="1">Heavy</option>
                  ...
                  <div class="form-group report-field col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select class="form-control" id="treatment_id" name="treatment_id" onchange="this.form.submit()">
                      <option value="">Select Treatment Name</option>
                      @foreach($result['allTreatments'] as $value)
            ...
            <table class="table table-bordered table-striped report-table datatable">
              <thead>
                <th style="text-align:center;">
                  @if (!empty($result['unPaidJobTreatments']))
                    
                    <button onclick="addUrlParameter('excel', '1')" class="btn btn-success" type="">Download</button>
   
                  @endif
                </th>
                <th colspan="9" style="font-size: 12px;">Count:

                  @if (!empty($result['unPaidJobTreatments']))
                  {{ count($result['unPaidJobTreatments'])}}
                  @else   
                  0
                   @endif
              ...
              @php
                  $i=0;
              @endphp
                  @foreach ($result['unPaidJobTreatments'] as $key => $value)
