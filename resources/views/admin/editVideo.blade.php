            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  @endif
                  <form role="form" id="Treatmentform" method="POST" action="{{url('/admin/updateVideo')}}" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                          ...
                          <input type="text" class="form-control required" value="{{ old('title',$result->title) }}" id="title" name="title" placeholder="Enter title">
                          @if ($errors->has('title'))
                        ...
                        <div class="form-group{{ $errors->has('path') ? ' has-error' : '' }}">
                          ...
                          <input type="text" placeholder="Enter path" class="form-control required" value="{{ old('path',$result->path) }}" id="path" name="path">
                          @if ($errors->has('path'))
                            <span class="help-block">
