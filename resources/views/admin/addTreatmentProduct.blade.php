...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Add Treatment Product</li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Add Treatment Product</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            ...
            @endif
            <form role="form" id="TreatmentProductform" method="POST" action="{{url('/admin/insertTreatmentProduct')}}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="form-group{{ $errors->has('product_id') ? ' has-error' : '' }}">
                    ...
                    <select class="form-control required" id="product_id" name="product_id">
                      ...
                      <option value="{{$product->id}}">{{$product->name}} | Unit: {{$product->quantity}}{{get_uom($product->uom)}} | Price: {{$product->price}}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control required" value="{{ old('quantity') }}" id="quantity" name="quantity" placeholder="Enter quantity" OnKeypress="return isNumber(event)" autocomplete="off">
                  ...
                  <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                    <label for="price">Price(in Rs.)<span class="required-title">*</span></label>
...
//       var FQ = $("#quantity").val(); 
//       var p = $("#pro_price").val();
//       var q = $("#pro_quantity").val();
//       var pByq = FQ/q*p;
//       $("#price").val(pByq.toFixed(2));
//     });
//   });
// });
