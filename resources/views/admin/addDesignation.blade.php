      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            @endif
            <form role="form" id="Staffform" method="POST" action="{{url('/admin/insertDesignation')}}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}" id="level">
                        ...
                        <select class="form-control required" id="level" name="level">
                          ...
                          <option @if(old('level') == $level->id) {{ 'selected' }} @endif value="{{$level->id}}">{{$level->level}}</option>
                          @endforeach
                        </select>
                        @if ($errors->has('level'))
                    ...
                    {{-- <div class="col-md-6">
                      <div class="form-group{{ $errors->has('department_id') ? ' has-error' : '' }}" id="level">
                        ...
                        <select class="form-control required" id="department_id" name="department_id">
                          ...
                          <option @if(old('department_id') == $department->id) {{ 'selected' }} @endif value="{{$department->id}}">{{ucwords($department->name)}}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                      <div class="form-group{{ $errors->has('designation') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control required" value="{{ old('designation') }}" id="designation" name="designation" placeholder="Enter Designation">
