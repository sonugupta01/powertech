      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            @endif
            <form role="form" id="templateForm" method="POST" action="{{url('/admin/insertDealerTemplate')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-group{{ $errors->has('template_id') ? ' has-error' : '' }}">
                    ...
                    <select class="form-control required" id="template_id" name="template_id">
                      ...
                      @foreach($templates as $template)
                        <option value="{{$template->id}}">{{ucwords($template->temp_name)}}</option>
                      @endforeach
                      </select>
