        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <p class="alert {{ Session::get('alert-class', 'alert-info') }}">
              ...
              @endif
              <form role="form" id="jobform" method="POST" action="{{url('/admin/updateJob')}}" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group{{ $errors->has('job_date') ? ' has-error' : '' }}">
                        ...
                        <div class="input-group date">
                          ...
                          <input onkeydown="return false" autocomplete="off" class="form-control pull-right" id="datepicker" value="{{ old('job_date',$result->job_date) }}" type="text" name="job_date" placeholder="Enter job date">
                        </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group{{ $errors->has('dealer_id') ? ' has-error' : '' }}">
                        ...
                        <select class="form-control required" id="dealer_id" name="dealer_id">
                          ...
                          <option @if($result->dealer_id == $dealer->dealer_id) {{ 'selected' }} @endif value="{{$dealer->dealer_id}}">{{$dealer->dealer_name}}</option>
                          @endforeach
                        </select>
                        ...
                        <script>
                          ...
                          $(document).ready(function() {
                            $('#job_type{{$key}}').on("change", function(e) {
                              ...
                              var treatment_id = $('#treatment_id{{$key}} option:selected').val();
                              ...
                              if (this.value == 1) {
                                ...
                                $.ajax({
                                  ...
                                  success: function(resp) {
                                    $(".difference{{$key}}").removeAttr("disabled");
                                    $('#customer{{$key}}').val(resp.gtp);
                                    $('.actualPrice{{$key}}').val(resp.gtp);
                                    $('.dealerPercent{{$key}}').val(resp.gdp);  
                                    // $(".discountPrice{{$key}}").removeAttr("disabled"); 
                                  }
                                });
                              }
      ...
      <script type="text/javascript">
        ...
        $(document).ready(function() {
          ...
          function getAllPrice(e) {
            $(e).parents('tr').find('select[name^="job_type"]').val("5");
            $(e).parents('tr').find('input[name^="difference"]').val("0");
            $(e).parents('tr').find('input[name^="difference"]').removeAttr("disabled");
