      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <!-- Modal -->
            <a href="{{url('/admin/addJob')}}" class="btn btn-success floatright">Add Job</a>
          </div><!-- /.box-header -->
            ...
            <div class="table-responsive">
              ...
              <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('/admin/editJob/')}}/{{$value->id}}"><i class="fa fa-edit" style="font-size: 20px;"></i></span></a>
                        <a href="{{ url('/admin/statusJob/delete/')}}/{{$value->id}}" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash" style="color: #d73925; font-size: 20px;"></i></a>
                      </td>
