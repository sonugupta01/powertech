      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Update product inventory of <b>{{get_template_name($temp_id)}}</b></h3>
            <a href="{{url('/admin/dealerTemplatesProducts')}}/{{$dealer_id}}/{{$primary_id}}" class="btn btn-info floatright" style="margin-right: 10px;">Back</a>
          </div><!-- /.box-header -->
          <div class="box-body">
            ...
            @endif
            <form role="form" id="inventoryForm" name="inventoryForm" method="POST" action="{{url('/admin/updateProductInventory')}}">
              ...
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-bordered table-hover" id="inventoryTbl">
                    ...
                    <tbody>
                      <tr>
                        <td class="col-sm-3"><input type="hidden" name="product_id" value="{{$pro_id}}">{{get_product_name($pro_id)}}</td>
                        ...
                        <td class="col-sm-3"><input type="hidden" name="pro_unit" value="{{get_product_unit($pro_id)}}" readonly/>@if(get_product_unit($pro_id)==1){{'Litre'}}@elseif(get_product_unit($pro_id)==2){{'ML'}}@elseif(get_product_unit($pro_id)==3){{'Pcs.'}}@elseif(get_product_unit($pro_id)==4){{'Gms.'}}@endif</td>
                      </tr>
                    </tbody>
                    <!-- <tfoot>
