            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Add Advisor for <b>{{get_name($dealer_id)}}</b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  @endif
                  <form role="form" id="Staffform" method="POST" action="{{url('/admin/insertAdvisor')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group{{ $errors->has('pan_no') ? ' has-error' : '' }}">
                              ...
                              <input type="text" class="form-control required" value="{{ old('pan_no') }}" id="pan_no" name="pan_no" placeholder="Enter PAN no.">
