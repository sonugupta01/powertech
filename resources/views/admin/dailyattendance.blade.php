                            ...
                            <form method="GET" action="">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" id="asm_id" name="asm_id">
                                        ...
                                        @foreach($asms as $asm)
                                            <option value="{{ @$asm->id }}" @if (@$asm->id == @$_GET['asm_id'])
                                                selected
                                            @endif>
                                                {{ @$asm->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if(!isset($employees))
                                    <a href="{{ url('admin/daily_attendance') }}" class="btn btn-info">Reset</a>
                                    @endif
                                    @if(@$employees)
                                    ...
                                    @if(count($result) > 0)
                                        @foreach($result as $key => $value)
                                            ...
                                            <td>{{$key+1}}</td>
                                                ...
                                                <td> <a href="{{ url('admin/daily_attendance') }}/{{ $result[$key]->dealer_id }}"
