                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group{{ $errors->has('designation') ? ' has-error' : '' }}">
                              ...
                              <select class="form-control required" id="designation" name="designation" style="width: 165px;">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group{{ $errors->has('doj') ? ' has-error' : '' }}">
                              ...
                              <input type="text" class="form-control required" value="{{ old('doj',@$dep_des->doj) }}" id="doj" name="doj" placeholder="Enter Employee Joining Date" autocomplete="off">
                              @if ($errors->has('doj'))
                              <span class="help-block">
                          ...
                          <div class="col-md-6">
                            <div class="form-group{{ $errors->has('dol') ? ' has-error' : '' }}">
                              ...
                              <input type="text" class="form-control required" value="{{ old('dol',@$dep_des->dol) }}" id="dol" name="dol" placeholder="Enter Employee Leaving Date" autocomplete="off">
                            </div>
                          </div>
                        </div>
                        <!-- /.box-body -->
