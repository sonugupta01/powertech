            ...
            <div id="tab01" class="tab-contents" >
              <form action="" class="" method="GET" >
                  ...
                  <div class="col-xs-6 col-md-6">
                    ...
                    <div class="form-group report-field col-md-3 ol-sm-3 ol-xs-12">
                      ...
                      <div class="form-group report-field col-md-2 ol-sm-2 ol-xs-12">
                        ...
                        <div class="form-group report-field col-md-1 col-sm-1 ol-xs-12" style="margin-top: 24px;">
                          <a href="{{url('rsm/attendance')}}" class="btn btn-primary">Reset</a> 
                        </div>
                      </div>
                       ...
                       <form action="{{url('rsm/attendance')}}" method="GET" id="get_employees">
                ...
                <div class="box-body" style="overflow: auto;">
                        ...
                        <tr>
                          ...
                          <th><button id="download" class="btn btn-success"
                            ...
                            <th style="text-align: center;"><button id="download" class="btn btn-success"
                              ...
                              <a href="{{ url('rsm/view_attendance') }}/{{ $result[0][0]->user_id }}" target="_blank" class="btn btn-primary">
                                view
                              </a>                                  
                              @endif
                          ...
                          <?php if (count($result) >= 1) { ?>
                            ...
                            <tr>
                              ...
                              <td><?php 
                                ...
                                <a href="{{ url('rsm/view_attendance') }}/{{ $value->user_id }}" target="_blank" class="btn btn-primary">
                                  view
                                </a>
                              </td>
                            </tr>
                  ...
                  <form method="get" id="form1" action="{{ url('/rsm/attendance') }}">
