...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('/rsm/jobs')}}"><i class="fa fa-tasks"></i> Jobs</a></li>
        ...
        <div class="box">
          ...
          <div class="box-body">
           @if(Session::has('addComErrmsg'))
            ...
            @endif
            <form role="form" id="jobform" method="POST" action="{{url('/rsm/updateJob')}}" enctype="multipart/form-data">
                      ...
                      <tbody>
                        @foreach($selectTreatment as $key => $value)
                          <tr id="selectData">
                              ...
                              <td class="col-sm-1">
                                  <input type="text" name="actualPrice[]" value="{{$value['actualPrice']}}" OnKeypress="return isNumber(event)" onkeyup="getdifference({{$key}})" class="form-control actualPrice{{$key}}" required/>
                              </td>
                              <td class="col-sm-2">
                                  <input type="text" name="difference[]" value="{{$value['difference']}}" class="form-control difference{{$key}}" readonly/>
                              </td>
                          ...
                          <script>
                            if ( $('#job_type{{$key}}').val() == 1 ) {
                                $(".actualPrice{{$key}}").val("0").attr("disabled", "disabled");
                                $(".difference{{$key}}").val("0");
                                ...
                                $(".actualPrice{{$key}}").removeAttr("disabled");
                                $(".difference{{$key}}").val();
                              }
