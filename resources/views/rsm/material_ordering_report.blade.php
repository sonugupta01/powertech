  ...
  <section class="content">
    <div class="row">
      <div class="tab-button-outer">
        <ul id="tab-button">
          <li class="is-active">
            <a href="#tab01">Material Order Report</a>
          </li>
        </ul>
      </div>
      <div class="tab-select-outer">
        <select id="tab-select">
          <option value="#tab01">Material Order Report</option>
        </select>
      </div>
      <div class="col-xs-12">
        <div class="box">
              ...
              <div class="row">
                ...
                <div class="col-md-offset-2 col-md-8 col-sm-12 resport-tabs" >
                    ...
                    <div class="form-group report-field col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="text" id="month" name="month" placeholder="Select Month" value="{{@request()->month}}" class="datePicker1 form-control" autocomplete="off" />
                    </div>
                    <div class="form-group report-field col-md-12 col-sm-12 col-xs-12">
                      <label>Dealer</label>
...
{{-- {{dd($result['productDetail'])}} --}}
                ...
                <tr>
                  ...
                  <td>{{@($value->minimum_stock-$value->stock_in_hand)}} {{$value->unit_name}}</td>
                </tr> 
                @endforeach
