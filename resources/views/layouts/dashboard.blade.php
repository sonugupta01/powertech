	...
	<div class="wrapper">
		...
		<li class="treeview">
			...
			<ul class="treeview-menu">
				...
				<li><a href="{{url('/admin/treatment_not_done_report')}}"><i class="fa fa-file"></i> Treatment Not Done Report</a></li>
		...
		<li class="treeview">
			...
			<ul class="treeview-menu">
				...
				<li><a href="{{url('/asm/treatment_not_done_report')}}"><i class="fa fa-file"></i> Treatment Not Done Report</a></li>
		...
		<li class="treeview">
			...
			<ul class="treeview-menu">
				...
				<li><a href="{{url('/rsm/treatment_not_done_report')}}"><i class="fa fa-file"></i> Treatment Not Done Report</a></li>
		...
		<li class="treeview">
			...
			<ul class="treeview-menu">
				...
				<li><a href="{{url('/sse/treatment_not_done_report')}}"><i class="fa fa-file"></i> Treatment Not Done Report</a></li>
