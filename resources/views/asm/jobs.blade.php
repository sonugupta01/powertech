      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class=" ro-box box box-primary" style=" margin-top: 10px;">
            <div class="box-body">
              <form method="POST" action="{{url('/asm/addServiceLoad')}}">
                <input type="hidden" name="_token" value="<?= csrf_token(); ?>">
                <div class="form-group">
                  <label for="dealer_id">Dealer<span class="required-title">*</span></label>
                  <select class="form-control required" id="dealer_id" name="dealer_id" required="">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <!-- Modal -->
            <a href="{{url('/asm/addJob')}}" class="btn btn-success floatright">Add Job</a>
          </div><!-- /.box-header -->
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                            <a href="{{ url('/asm/editJob/')}}/{{$value->id}}"><i class="fa fa-edit" style="font-size: 20px;"></i></a>
                            <a href="{{ url('/asm/statusJob/delete/')}}/{{$value->id}}" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash" style="color: #d73925; font-size: 20px;"></i></a>
                        </td>
...
<form id="deleteForm" action="{{url('/asm/deleteJobs')}}" method="GET">
...
setTimeout(function() {
  ...
  $(document).ready(function(){
   ...
   $('#datepicker').datepicker({ autoclose: true, startDate: '-3d', format: 'yyyy-mm-dd', endDate: '+0d' }); 
