      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <form role="form" id="planeform" method="POST" action="{{url('/asm/updateDealer')}}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group{{ $errors->has('district_id') ? ' has-error' : '' }}">
                  ...
                  <select class="form-control required" id="district_id" name="district_id">
                    ...
                    <option @if($result->district_id == $district->district_id) {{ 'selected' }} @endif value="{{ $district->district_id }}">{{ $district->district_name }}</option>
