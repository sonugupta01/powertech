...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('/asm/targets')}}"><i class="fa fa-dashboard"></i> Targets</a></li>
              ...
              <tbody>
                ...
                ?>
                      ...
                      <tr id="defaultData">
                        ...
                        {{-- <td> --}}
                          {{-- <a href="{{ url('/asm/editTempTarget')}}/{{$dealer_id}}/{{$template_id}}/{{$value->id}}" class="btn btn-success">Edit</a> --}}
                        {{-- <a href="{{ url('/asm/statusTarget/delete')}}/{{$value->id}}" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger">Delete</a> --}}
                        {{-- </td> --}}
                      </tr>
...
//             html += '<td>'+(i+1)+'</td><td>'+data[i].treatment_id+'</td><td>'+data[i].target_num+'</td><td>'+data[i].customer_price+'</td><td>'+data[i].total_target+'</td><td><a href="{{url('asm/editTempTarget')}}/'+dealer_id+'/'+template_id+'" class="btn btn-md btn-success add" id="add'+data[i].id+'"><b>Edit</b></a></td>';
//           }
