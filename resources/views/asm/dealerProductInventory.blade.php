...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('/asm/dealer_management')}}"><i class="fa fa-dashboard"></i> Dealers</a></li>
        ...
        <div class="box">
          <div class="box-header">
            <div class="row">
              ...
              <div class="col-md-3">
                  <form action="{{url('asm/downloadProductInventory')}}/{{$dealer_id}}" id="downloadProductInventory" method="GET">
                ...
                ?>
                    <tr id="defaultData">
                      ...
                      <td>
                        ...
                        @endif
                      <td>
                        <a href="{{ url('/asm/dealerProductInventory')}}/{{$dealer_id}}/{{$value->id}}" class="btn btn-success" {{$selectedDate != date('Y-m')?'disabled':''}}>Update</a>
                      </td>
                    </tr>
                  <?php
                  //   $i++;
