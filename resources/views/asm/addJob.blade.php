      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            @endif
            <form role="form" id="jobform" method="POST" action="{{url('/asm/insertJob')}}" enctype="multipart/form-data" onsubmit="return validateForm()">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group{{ $errors->has('dealer_id') ? ' has-error' : '' }}">
                      ...
                      <select class="form-control required" id="dealer_id" name="dealer_id">
                        ...
                        <option value="{{$dealer}}" @if(old('dealer_id')==$dealer) {{ 'selected' }} @endif>{{get_dealer_name($dealer)}}</option>
                        @endforeach
                      </select>
              ...
              <table id="myTable" class=" table order-list">
                ...
                <tbody>
                  <tr id="selectData">
                    ...
                    <td class="col-sm-2">
                      <input type="text" value="" class="form-control difference0" name="difference[]" maxlength="2" OnKeypress="return isNumber(event)" onkeyup="getdifference(0)" required />
                    </td>
                    <td class="col-sm-2">
                      <input type="text" value="" class="form-control actualPrice0" name="actualPrice[]" readonly />
                    </td>
                    {{-- <td class="col-sm-3">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#addrow").on("click", function() {
      ...
      cols += '<td><input type="text" value="" class="form-control difference' + counter + '" name="difference[]" maxlength="2" OnKeypress="return isNumber(event)" onkeyup="getdifference(' + counter + ')"  required/></td>';
