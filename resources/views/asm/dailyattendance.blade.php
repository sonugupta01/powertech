...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <li class="active"><a href="{{url('asm/daily_attendance/')}}">Daily Report</a></li>
        </ol>
    </section>
                        ...
                        <div class="col-md-12">
                            <form method="GET" action="">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if(!isset($employees))
                                    <a href="{{ url('asm/daily_attendance') }}" class="btn btn-info">Reset</a>
                                    @endif
                                    @if(@$employees)
                                    ...
                                    @if(count($result) > 0)
                                        @foreach($result as $key => $value)
                                            ...
                                            <td>{{$key+1}}</td>
                                                ...
                                                <td> <a href="{{ url('asm/daily_attendance') }}/{{ $result[$key]->dealer_id }}"
