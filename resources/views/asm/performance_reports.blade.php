                          ...
                          <tbody>
                            ...
                            @foreach($advisors as $value)
                              <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" href="{{url('/asm/downloadAdvisor')}}/{{$value->advisor_id}}/{{$value->dealer_id}}/{{@$month}}">Download</a>
                                </td>
                              </tr>
                            @endforeach                          
                            <?php  
...
<form method="get" id="form1" action="{{url('/asm/downloadPerformanceSheet')}}">
  <input type="hidden" name="selectMonth1" value="{{@$month}}">
  <input type="hidden" name="dealer1" value="{{@$oldDealer}}">
</form> 
<form method="get" id="form2" action="{{url('/asm/downloadAllAdvisor')}}">
