...
class SseController extends Controller
{
    ...
    public function insertDealer(Request $request)
    {
        ...
        return redirect('/sse/dealer_management');
    }
    ...
    public function statusStaff($status, $id)
    {
        ...
        return redirect('/sse/staff_management');
    }
    ...
    public function editEmpHierarchy($id)
    {
        ...
        if (empty($result)) {
            ...
            $reporting_authorities = DB::table('users as u')
                ...
                ->select('u.id as uid', 'u.name as uname', 'sd.designation_id as des_id')
                ->get();
            return view('sse.editEmpHierarchy', [
                'result' => $result,
                'dealers' => $dealers,
                'dep_des' => $dep_des,
                'levels' => $levels,
    ...
    public function updateEmpHierarchy(Request $request)
    {
        ...
        return redirect('/sse/staff_management')->with('success', 'data updated succesfully');
    }
    ...
    public function statusEmpHierarchy($status, $id)
    {
        ...
        return redirect('/sse/emp_hierarchy');
    }
    ...
    public function insertJob(Request $request)
    {
        ...
        //     return redirect('/sse/addJob')->with('error',$error);
        // }else{
        $data = array(
    ...
    public function editJob($id)
    {
        ...
        foreach (json_decode($result->treatments) as $value) {
            ...
            $select['actualPrice'] = @$value->actual;
    ...
    public function jobsTreatmentList(Request $request)
    {
        ...
        return view('sse.jobsTreatmentList', [
    ...
    public function consumptionReport_old(Request $request)
    {
        ...
        return view('sse.consumptionReport_old', [
            'treatments' => @$treatments,
            'dealers' => $dealers,
            'oldDealer' => @$search['dealer'],
    ...
    public function performance_reports(Request $request)
    {
        ...
        $advisors = DB::table('jobs')
            ...
            ->get();
        //dd($advisors);
        return view('sse.performance_reports', [
            'dealers' => $dealers,
            'advisors' => $advisors,
            'oldDealer' => @$search['dealer'],
            'oldMonth' => @$search['selectMonth'],
    ...
    public function view_attendance($id)
    {
        ...
        // return view('admin/view_attendance')->with('result', $data);
        $list = array();
    ...
    public function daily_attendance($dealer_id = null)
    {
        ...
        if (!empty($dealer_id)) {
            ...
            return view('sse/dailyattendance')->with('employees', $employees);
        } else {
        ...
        return view('sse/dailyattendance')->with('result', $result)->with('firms', $firms);
    }
