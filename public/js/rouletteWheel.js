...
$.widget('javobyte.rouletteWheel', {
    ...
    options: {
        pointer: $('<img>').attr('src', 'https://assets.babyvote.com/assets/down-arrow-139a116a2d3c49a68fe0823d378067ee.png')[0],
        selected: function () {
        },
        spinText: 'SPIN',
        colors: [],
